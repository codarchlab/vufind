...
curl -H "Accept: application/json" "https://publications.dainst.org/journals/plugins/generic/cilantro/api/zenon" > $VUFIND_HOME/local/iDAI.world/publications_serials_mapping.json
